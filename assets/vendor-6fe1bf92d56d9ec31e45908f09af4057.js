...
return null===e?0:e+1}get previousOption(){return this.options[this.previousOptionIndex]}get nextOption(){return this.options[this.nextOptionIndex]}get interactiveElement(){return this.hasInput?this.inputElement:this.hasTrigger?this.triggerElement:this.optionsElement}get hasFocus(){return this.interactiveElement===document.activeElement}get optionElements(){return[...new Set(this._options.map((e=>e.element.parentElement)))].reduce(((e,t)=>{const n=[...t.querySelectorAll(".select-box__option")]
return e.push(...n),e}),[])}get options(){return this._options.filter((e=>!e.isDisabled)).sort(((e,t)=>this.optionElements.indexOf(e.element)-this.optionElements.indexOf(t.element)))}handleInsertElement(e){this.element=e,this.args.onReady?.(this.api)}handleDestroyElement(){this.element=null}handleInsertOption(e){this._options.push(e)}handleDestroyOption(e){const t=this._options.indexOf(e)
this._options[t]=this._options[this._options.length-1],this._options.pop()}handleInsertOptions(e){this.optionsElement=e}handleDestroyOptions(){this.optionsElement=null}handleInsertTrigger(e){this.triggerElement=e}handleDestroyTrigger(){this.triggerElement=null}handleInsertInput(e){this.inputElement=e}handleDestroyInput(){this.inputElement=null}registerDropdown(e){this.dropdown=e}handleDestroyDropdown(){this.dropdown=null}handleInput(){this._search(this.inputElement.value)}handleMouseLeave(){this.hasFocus||this._forgetActiveOption()}handleMouseDown(e){e.target!==this.interactiveElement&&(e.preventDefault(),this._ensureFocus())}handleKeyDownTrigger(e){this._handleKeyDown(e),this._handleInputChar(e)}handleKeyDownInput(e){this._handleKeyDown(e)}handleKeyDownOptions(e){this.isComboBox||(this._handleKeyDown(e),this._handleInputChar(e))}handleMouseEnterOption(e){this._activateOption(e)}handleMouseUpOption(e,t){0===t.button&&(this._activateOption(e),this._selectOption(e))}handleFocusInOption(e){this._activateOption(e)}handleKeyDownOption(e){this._handleKeyDown(e)}handleOpenDropdown(){this.activeOption?.scrollIntoView(),this._ensureFocus()}handleCloseDropdown(e){this._forgetActiveOption(),e===U&&this._ensureFocus()}search(e){return this._search(e)}update(e){this._setValue(e)}select(e){this._selectValue(e)}_handleKeyDown(e){switch(e.key){case"ArrowUp":this._handleArrowUp(e)
break
