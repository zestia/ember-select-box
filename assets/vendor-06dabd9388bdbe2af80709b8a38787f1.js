...
return new RegExp(function(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}(s)).test(o)},e.pressingModifier=function(e){return e.ctrlKey||e.altKey||e.shiftKey||e.metaKey},e.sortOptionsFast=function(e){return(t,n)=>e.indexOf(t.element)-e.indexOf(n.element)},e.sortOptionsSlow=function(e,t){return e.element.compareDocumentPosition(t.element)===Node.DOCUMENT_POSITION_FOLLOWING?-1:1},e.startsWithString=function(e,i){const o=r(t(n(e))),s=t(n(i))
...
const e=this._options.filter((e=>!e.isDisabled))
if(e.some((e=>!e.isConnected)))return e.sort(c.sortOptionsSlow)
{const t=[...this.element.querySelectorAll(".select-box__option")]
return e.sort((0,c.sortOptionsFast)(t))}}handleInsertElement(e){this.element=e,this.args.onReady?.(this.api)}handleDestroyElement(){this.element=null}handleInsertOption(e){this._options.push(e)}handleDestroyOption(e){const t=this._options.indexOf(e)
