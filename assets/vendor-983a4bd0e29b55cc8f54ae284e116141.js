...
return null===e?0:e+1}get previousOption(){return this.options[this.previousOptionIndex]}get nextOption(){return this.options[this.nextOptionIndex]}get optionElements(){return[...this.element.querySelectorAll(".select-box__option")]}get interactiveElement(){return this.hasInput?this.inputElement:this.hasTrigger?this.triggerElement:this.optionsElement}get hasFocus(){return this.interactiveElement===document.activeElement}get options(){if(!this.element)return[]
const e=this.optionElements
return this._options.filter((e=>!e.isDisabled)).sort(((t,n)=>e.indexOf(t.element)-e.indexOf(n.element)))}handleInsertElement(e){this.element=e,this.args.onReady?.(this.api)}handleDestroyElement(){this.element=null}handleInsertOption(e){this._options.push(e)}handleDestroyOption(e){const t=this._options.indexOf(e)
this._options[t]=this._options[this._options.length-1],this._options.pop()}handleInsertOptions(e){this.optionsElement=e}handleDestroyOptions(){this.optionsElement=null}handleInsertTrigger(e){this.triggerElement=e}handleDestroyTrigger(){this.triggerElement=null}handleInsertInput(e){this.inputElement=e}handleDestroyInput(){this.inputElement=null}registerDropdown(e){this.dropdown=e}handleDestroyDropdown(){this.dropdown=null}handleInput(){this._search(this.inputElement.value)}handleMouseLeave(){this.hasFocus||this._forgetActiveOption()}handleMouseDown(e){e.preventDefault(),this._ensureFocus()}handleKeyDownTrigger(e){this._handleKeyDown(e),this._handleInputChar(e)}handleKeyDownInput(e){this._handleKeyDown(e)}handleKeyDownOptions(e){this.isComboBox||(this._handleKeyDown(e),this._handleInputChar(e))}handleMouseEnterOption(e){this._activateOption(e)}handleMouseUpOption(e,t){0===t.button&&(this._activateOption(e),this._selectOption(e))}handleFocusInOption(e){this._activateOption(e)}handleKeyDownOption(e){this._handleKeyDown(e)}handleOpenDropdown(){this.activeOption?.scrollIntoView(),this._ensureFocus()}handleCloseDropdown(e){this._forgetActiveOption(),e===U&&this._ensureFocus()}search(e){return this._search(e)}update(e){this._setValue(e)}select(e){this._selectValue(e)}_handleKeyDown(e){switch(e.key){case"ArrowUp":this._handleArrowUp(e)
break
case"ArrowDown":this._handleArrowDown(e)
break
case"Enter":this._handleEnter(e)
break
case" ":this._handleSpace(e)}}_handleArrowUp(e){e.preventDefault(),this.canAutoOpen?this.dropdown.open():this._activateOption(this.previousOption,!0)}_handleArrowDown(e){e.preventDefault(),this.canAutoOpen?this.dropdown.open():this._activateOption(this.nextOption,!0)}_handleEnter(e){this.isComboBox&&e.preventDefault(),this._handleEnterOrSpace()}_handleSpace(e){e.target!==this.inputElement&&(e.preventDefault(),this.isTyping||this._handleEnterOrSpace())}_handleEnterOrSpace(e){this.canAutoOpen?this.dropdown.open():this._selectActiveOption()}_handleSelected(){(this.args.onSelect?.(this.api)??this.canAutoClose)&&this.dropdown.close(U)}_handleSearched(){this.activeOption?.scrollIntoView()}_handleInputChar(e){const{key:t}=e
