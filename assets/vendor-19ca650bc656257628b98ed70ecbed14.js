...
break
case" ":this._handleSpace(e)}}_handleArrowUp(e){e.preventDefault(),this.canAutoOpen?this._open():this._activatePreviousOption()}_handleArrowDown(e){e.preventDefault(),this.canAutoOpen?this._open():this._activateNextOption()}_handleEnter(e){e.target===this.inputElement&&(this.activeOption||this.canAutoOpen)&&e.preventDefault(),this._handleEnterAndSpace(e)}_handleSpace(e){e.target!==this.inputElement&&""===this.chars.trim()&&(e.preventDefault(),this._handleEnterAndSpace(e))}_handleEnterAndSpace(e){this.canAutoOpen?this._open():(this._selectActiveOption(e),this.canAutoClose&&this._close())}_handleEscape(e){this.canClose&&e.stopPropagation(),this._close(Symbol("ESCAPE"))}_handleFocusLeave(){this._deactivateOptions(),this._close(Symbol("FOCUS_LEAVE"))}_handleClickAbort(){this._close(Symbol("CLICK_ABORT"))}_handleSelected(){(this.args.onSelect?.(this.api)??this.canAutoClose)&&this._close(Symbol("SELECTED"))}_handleOpened(){this._activateInitialOption(),this._ensureFocus()}_handleClosed(){let{description:e}=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
